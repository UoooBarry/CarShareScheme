        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        req.validationError = [];
                        return [4 /*yield*/, carRepository_1["default"].get(req.body.car_id)];
                    case 1:
                        car = _a.sent();
                        if (!car.available)
                            req.validationError.push('The car does not available yet');
                        if (!req.body.car_id)
                            req.validationError.push('Car cannot be empty');
                        if (!req.body.period || req.body.period <= 0)
