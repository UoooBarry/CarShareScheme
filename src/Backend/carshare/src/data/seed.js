    ...
    if (cars.length === 0 && process.env.NODE_ENV !== 'test') {
      location = await Location.findAll({ where: {} });
        ...
        await Car.create({
          ...
          purchase_date: new Date(2019, 11, 1),
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2013, 8, 1),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2019, 12, 1),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2019, 9, 1),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2019, 10, 9),
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2019, 6, 28),
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2019, 3, 9),
          addons: "GPS, Air Conditioning, MP4, Convertible",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2020, 3, 1),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2018, 9, 1),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2020, 2, 1),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2020, 1, 9),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2020, 2, 13),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2020, 3, 14),
          addons: "GPS, Air Conditioning, MP4",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2020, 3, 19),
          addons: "GPS, Air Conditioning, MP4, Convertible",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2020, 7, 18),
          addons: "GPS, Air Conditioning, MP4,Sky Window",
          available: true,
        ...
        await Car.create({
          ...
          gear: "automatic",
          location_id: location[Math.floor(Math.random() * 3)].id,
          purchase_date: new Date(2020, 5, 19),
          addons: "GPS, Air Conditioning, MP4,Sky Window",
          available: true,
