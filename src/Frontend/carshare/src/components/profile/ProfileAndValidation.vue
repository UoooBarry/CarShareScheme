...
<template>
  <div id="second-container" class="container">
    ...
    >
      <div v-if="step == 1">
        <font-awesome-icon icon="user-cog" style="margin-right:8px" />
        {{ $t('PersonalInformation') }}
      </div>
      <div v-if="step == 2">
        <font-awesome-icon icon="id-badge" style="margin-right:8px" />
...
import ValidationHolder from "./ValidationHolder";
export default {
  name: "profileAndValidation",
  props: ["customer"],
  components: {
    InformationProfile,
    ValidationHolder
