<template>
  <div class="container">
    <h1 class="text-md-left mb-5 px-2">Terms & Policy</h1>
    <p
      class="text-md-left mb-5 px-2"
    ...
    <p
      class="text-md-left mb-5 px-2"
    >These terms apply to any booking that you make with us on or through this website, so you should make sure that you are aware of their contents. Both our terms and those of the car hire companies we work with contain some exclusions and limitations of liability.</p>
    ...
    <h1 class="text-md-left mb-5 px-2">Privacy Notice</h1>
    ...
    <p
      class="text-md-left mb-5 px-2"
    >We may change this Notice from time to time; so please check back here for any updates.</p>
    ...
    <h1 class="text-md-left mb-5 px-2">Minimum / Maximum Age Limitations</h1>
    ...
    <h1 class="text-md-left mb-5 px-2">Late Pick-ups / Early Drop-offs</h1>
    ...
    <h1 class="text-md-left mb-5 px-2">If We Make Changes to Your Booking</h1>
    ...
    <h1 class="text-md-left mb-5 px-2">Personal data you give us</h1>

    <p
      class="text-md-left mb-5 px-2"
    >We store and use the information that you give us. When you make a booking, we need at least your name, email address and payment information. We might also ask for your home address, phone number and date of birth, and the names of any additional drivers.</p>

    <p
      class="text-md-left mb-5 px-2"
    >If you get in touch with us (by phone, by email or through social media, for example) we will collect information from you there too.</p>

    <p
      class="text-md-left mb-5 px-2"
    >After your booking, we may ask you to provide a review to help us improve our services, and to help ensure future customers get exactly what they’re looking for.</p>
    ...
    <h1 class="text-md-left mb-5 px-2">Personal data you give us about others</h1>
    ...
    <h1 class="text-md-left mb-5 px-2">Personal data we collect automatically</h1>

    <p
      class="text-md-left mb-5 px-2"
    >When you make a booking, we record what platform you made it on, and how you got to our platform (if you came through from another site, for example).</p>
    <h1 class="text-md-left mb-5 px-2">Confirming your booking and taking payment</h1>
    ...
    <p
      class="text-md-left mb-5 px-2"
    >Until your car is confirmed, you can ‘void’ the payment at any time. Just hit ‘Manage booking’ at the top of our site, enter the email address provided when making the booking and reservation number, then hit ‘Cancel Booking’. We will unblock the money on your card.</p>

    <p
      class="text-md-left mb-5 px-2"
    >Very rarely, a car hire company can’t confirm that a car is available. If this happens, we will tell you, and unblock the money on your card.</p>

    <p
      class="text-md-left mb-5 px-2"
    >When you book a car or other product on our site, we will email you to confirm its availability within 48 hours of booking (or, if earlier, at least 24 hours before your pick-up time). We will then send you a booking confirmation.</p>
    ...
    <h1 class="text-md-left mb-5 px-2">Accuracy of Information</h1>
    ...
    <p
      class="text-md-left mb-5 px-2"
    >The Rentalcars.com voucher / eVoucher must be presented to the car hire company when picking up your hire car. We cannot be held responsible for rentals rejected if a voucher / eVoucher is not presented.</p>

    <p
      class="text-md-left mb-5 px-2"
    >We cannot accept liability for any charges incurred as a result of documentation signed for and accepted at the car hire counter.</p>

    <p
      class="text-md-left mb-5 px-2"
    >We will not be held responsible for anyone driving under the influence of alcohol/drugs, causing wilful damage, driving off-road or driving without due care and attention. You, will accept full responsibility in respect of such claims. This list is not exhaustive.</p>
  </div>
</template>F